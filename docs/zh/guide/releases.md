...
- 修复日志时间解析错误
- 修复全局设置保存值不一致问题
- 修复阿里私享 DOH 开关读取与写入问题
- 修复启动服务时 supervisord 自启动问题

### 📝 备注（Notes）
- 建议重新安装或更新以重置系统并重新初始化
- 直接升级可能存在其他问题
- MosDNS 配置重构并优化配置页面适配

::: details 📋 构建信息
- **源提交**: [`a345a31`](https://github.com/msm9527/msm/commit/a345a31371ef1665a17e3cd19446e115327144a5)
- **提交信息**: 修复多个界面问题和功能增强
- **提交作者**: doumao
- **提交时间**: 2026-01-17 00:39:32 +0800
:::
