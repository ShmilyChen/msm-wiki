...
- 修复 mihomo 配置升级前自动备份 config.yaml
- 修复 mihomo 配置升级保留自定义顶层锚点
- 修复 sysctl 写入补换行校验问题
- 修复 mosdns 升级后重启服务问题
- 修复 mosdns 未初始化时跳过配置升级问题
...
::: details 📋 构建信息
- **源提交**: [`b432027`](https://github.com/msm9527/msm/commit/b432027f7f393f6ea5a8b99eef2b5ed8e6ace6ad)
- **提交信息**: 优化下载加速优先级策略
- **提交作者**: doumao
- **提交时间**: 2026-01-13 18:08:03 +0800
:::
